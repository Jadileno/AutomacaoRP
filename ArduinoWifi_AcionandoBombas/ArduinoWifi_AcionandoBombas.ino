    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n')
        {
          ...
          client.println("</head>");
          client.println("<body>");
          client.println("<div id='wrapper'><img alt='RoboticParts' src='/Jadileno/Acionamento_Bomba_WiFi/blob/master/ProjetoBombaAgua_ArduinoWiFi/logo/Testes.png?raw=true'/><br/>");
          client.println();
          client.println();
